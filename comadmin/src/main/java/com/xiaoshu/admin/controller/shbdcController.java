...
@RestController
@RequestMapping("admin/shbdc/res")
public class shbdcController {
	...
	public String shbdcysj(@RequestParam(name = "start", required = false) Integer start,
		...
		List<ShMain> list = shMainSwService.shbdcAllList(test);
